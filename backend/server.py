...
def is_bot_comment(author: str, text: str) -> bool:
    ...
    # Specific bot usernames to exclude (WITH @ symbol - YouTube returns it this way)
    bot_usernames = {
        '@HarryResearch-s7o',
        '@hindigyanworld9511',
        '@jimmyjk007',
    ...
    # Check if author is in bot list (using set for O(1) lookup)
    return author in bot_usernames
Key Changes:
Changed [ to { - Using a set instead of a list for faster lookups
Added @ to all usernames - Match exactly what YouTube returns
Removed the lstrip logic - No need to clean the author name
Simplified return - Just return author in bot_usernames
After Making the Change:
Save the file (Ctrl+S)
Wait 2-3 seconds for hot reload
Test with the same video: https://www.youtube.com/watch?v=9WewDoZLhq4
You should see 21 BOTS Detected
That's it! This is the only change you need to make.
