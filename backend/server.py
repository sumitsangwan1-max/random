...
def is_bot_comment(author: str, text: str) -> bool:
    ...
    bot_usernames = [
        "@HarryResearch-s7o",
        "@hindigyanworld9511",
        # ... all your bot usernames with @
    ]
    
    # Check if author matches any bot username (case-insensitive)
    return author in bot_usernames
REPLACE it with this new function (WITHOUT @ symbols):

def is_bot_comment(author: str, text: str) -> bool:
    """Detect bot comments from blacklisted usernames"""
    # Specific bot usernames to exclude (WITHOUT @ symbol)
    bot_usernames = [
        "HarryResearch-s7o",
        "hindigyanworld9511",
        "jimmyjk007",
...
"@LuckyDayMay",
    ...
    # Check if cleaned author matches any bot username (case-insensitive)
    return author_clean.lower() in [name.lower() for name in bot_usernames]
